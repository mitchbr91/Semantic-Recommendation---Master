...
public class RegularRecommendationID implements java.io.Serializable{
    ...
    public RegularRecommendationID(){
    	
    }
    
    public RegularRecommendationID(Long userID, Long recommendationID){
    	this.userID = userID;
	...
	public boolean equals(Object obj) {
		...
		RegularRecommendationID other = (RegularRecommendationID) obj;
